...
func TestArticleUnauthenticated(t *testing.T) {
	...
	// Define the route similar to its definition in the routes file
	r.GET("/a/view/:article_id", getArticle)

	// Create a request to send to the above route
	req, _ := http.NewRequest("GET", "/a/view/1", nil)
...
func TestArticleCreationPageAuthenticated(t *testing.T) {
	...
	// Create a request to send to the above route
	req, _ := http.NewRequest("GET", "/a/create", nil)
	req.Header = http.Header{"Cookie": w.HeaderMap["Set-Cookie"]}
...
func TestArticleCreationPageUnauthenticated(t *testing.T) {
	...
	// Define the route similar to its definition in the routes file
	r.GET("/a/create", ensureLoggedIn(), showArticleCreationPage)
...
func TestArticleCreationAuthenticated(t *testing.T) {
	...
	req, _ := http.NewRequest("POST", "/a/create", strings.NewReader(articlePayload))
	req.Header = http.Header{"Cookie": w.HeaderMap["Set-Cookie"]}
...
func TestArticleCreationUnauthenticated(t *testing.T) {
	...
	// Define the route similar to its definition in the routes file
	r.POST("/a/create", ensureLoggedIn(), createArticle)
